"""
Engine Architecture
    - Front fan and rear fan on LPS, driven by LPT.
    - Axial compressor + radial compressor on HPS, driven by HPT.
"""
...
CONFIG_PATH = Path(__file__).resolve().parent.parent/'Config_Files'/'Config_003.yaml'
OUTPUT_PATH = Path(__file__).resolve().parent.parent/'Output'/'Output_003.txt'
...
Turbofan.interface(     "FAN.FlowOut_BYP",   "FAN_RE.FlowIn", "S13" )
Turbofan.interface(  "FAN_RE.FlowOut",      "NOZ_BYP.FlowIn", "S15" )
...
Turbofan.interface(    "FAN.Shaft", "LPS", "FAN_FR_ShaftLink" )
Turbofan.interface( "FAN_RE.Shaft", "LPS", "FAN_RE_ShaftLink" )
