...
from src.Python.Combustor import CMB_Air_Distribution1 as air_dist

t3 = 900 # K
t4 = 1300 # K;
tSecondaryDesired = 1800 # K
tFlame = 2500 # K
mDot3 = 50 # kg/s
...
pzd, szd, dzd = air_dist.Calc_Air_Distribution(t3, t4, tSecondaryDesired, tFlame, mDot3, fuelAirRatio, cp3, cpPrimary)
